    ...
    useEffect(() => {
        ...
        try {
            viewerRef.current = createIFCViewer({
                ...
                // REMOVED: initialModel - will load manually after viewer is ready
                features: {
                    minimap: false,
                    measurement: false,
                    clipping: false,
            ...
            setTimeout(async () => {
                try {
                    ...
                    if (viewer && 'loadModelFromUrl' in viewer && typeof viewer.loadModelFromUrl === 'function') {
                        ...
                        console.error('loadModelFromUrl not found');
                    }
                } catch (err) {
        ...
        return () => {
            // Defer unmount to avoid React 18 Strict Mode warning
            queueMicrotask(() => {
