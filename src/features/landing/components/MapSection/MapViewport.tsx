...
export const MapViewport = ({
  ...
  return (
    <div className="relative w-full h-[75vh] border border-gray-200 bg-white overflow-hidden flex">
      {/* Sidebar for controls */}
      <div className="w-16 md:w-20 bg-gray-50 border-r border-gray-200 p-2 flex flex-col items-center gap-4 z-40">
        <motion.div
        ...
        <motion.div
          ...
          className="flex flex-col items-center gap-3 bg-white border-2 border-black p-1"
        >
          <button
            onClick={() => {
              onShowList(false);
            ...
            className={`flex items-center justify-center w-12 h-12 text-xs font-mono font-bold uppercase tracking-wider transition-all ${
          ...
          <button
            ...
            aria-label={`Show list with ${filteredLocations.length} locations`}
          >
            <svg className="w-6 h-6" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
